...
<head>
  ...
  <script> 
  puts $::HTML {var selected_tech="none";}
...
#  </div>
  ...
  <script> 
      ...
      function initForm() {
	      document.getElementById("tech").selectedIndex = 0\;
	      document.getElementById("tech").onchange = UpdateTech()\;
      }
      set tech_list {}
      ...
      function UpdateTech() {
      	var tech_array = new Array($tech_list)\;
	selected_tech = tech_array[this.selectedIndex].value\;
      }
      </script>
	<select id="tech">
		...
		set i 0
		foreach tech [array names ::tech_names] {
		    <option value="$i">$::tech_names($tech)</option>
		    incr i
		}
	</select>
  </div>
