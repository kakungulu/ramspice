...
set y_unit {}
if {[info exists ::sizers($y,unit)]} {
    set y_unit $::sizers($y,unit)
}
set z_unit {}
...
::SVG::svg width $outer_frame_size height $outer_frame_size {
    if {$z=="none"} {
        ::SVG::graph_pareto_front x 100 y 100 width $frame_size height $frame_size data $pixels markers 1:green x_title $x y_title $y x_unit $x_unit y_unit $y_unit title $::opt(title)
    } else {
