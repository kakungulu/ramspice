...
#Foreach: ::type {nch pch} {
    ...
    #Foreach: ::corner {ss tt ff fs sf mc} {
        #For: {set ::section 1} {[info exists ::bin($::t,$::section,lmin)]} {incr ::section} {
            ...
            void Gamma_BSIM4v5_Calc_${::type}_${::corner}_${::section}(float Vgs_in,float Vds_in,float Vbs_in,float L_in,float W_in) { 
                ...
                */
                ...
                {   ceqgstot = ${::TECH($::type,$::corner,$::section,type)} * (here->BSIM4v5gstotd * vds
                    ...
                    ceqgdtot = -${::TECH($::type,$::corner,$::section,type)} * (here->BSIM4v5gdtotd * vds
