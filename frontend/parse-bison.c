...
{
  "$end", "error", "$undefined", "TOK_NUM", "TOK_STR", "TOK_LE", "TOK_GE",
  ...
  if (yydebug)								  \
    {									  \
      ...
      yy_symbol_print (stderr,						  \
		  Type, Value, Location, line, retval); \
      YYFPRINTF (stderr, "\n");						  \
    }									  \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, char **line, struct pnode **retval)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, line, retval)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, char **line, struct pnode **retval)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, line, retval)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, char **line, struct pnode **retval)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, line, retval)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    char **line;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, line, retval); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, char **line, struct pnode **retval)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, line, retval)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (char **line, struct pnode **retval);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (&yylloc, line, retval, yymsgp);
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, yylsp, line, retval);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, yylsp, line, retval);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
