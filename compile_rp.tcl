...
set preprocessed /tmp/ramspice_build_rp/preprocessed
set object_files /tmp/ramspice_build_rp/object_files
set target_name $::env(RAMSPICE)/ramspice_rp
...
puts $O "#!/bin/tcsh"
puts $O "setenv PATH /home/ystatter/raspberrypi/tools/arm-bcm2708/arm-bcm2708-linux-gnueabi/arm-bcm2708-linux-gnueabi/bin/:/opt/centos/devtoolset-1.0/root/usr/bin/:\$PATH"
set pre_c "/home/ystatter/raspberrypi/tools/arm-bcm2708/arm-bcm2708-linux-gnueabi/arm-bcm2708-linux-gnueabi/bin/gcc -I${preprocessed} -I. -lm -ltcl8.5  -g -O5 -Wall -Wextra -Wmissing-prototypes -Wstrict-prototypes -Wnested-externs -Wold-style-definition -Wredundant-decls -Wconversion -I/usr/include/c++/4.4.4/x86_64-redhat-linux -I${preprocessed}/BerkeleyDB.6.0/include -IBerkeleyDB.6.0/include -ldb-6.0  -I${preprocessed}/maths/poly -Imaths/poly -I${preprocessed}/frontend -Ifrontend -I${preprocessed}/spicelib/devices -Ispicelib/devices -I${preprocessed}/xspice/icm/analog -Ixspice/icm/analog $SP_PREPROCESS_FLAG -D SENSDEBUG -D X_DISPLAY_MISSING -D CIDER -D SIMULATOR -c"
set pre_cpp "/home/ystatter/raspberrypi/tools/arm-bcm2708/arm-bcm2708-linux-gnueabi/arm-bcm2708-linux-gnueabi/bin/g++  -I${preprocessed} -lm -ltcl8.5  -g -O5 -Wall -Wextra -fpermissive -Wredundant-decls -Wconversion -I${preprocessed}/BerkeleyDB.6.0/include -I${preprocessed}/maths/poly -I${preprocessed}/frontend -I${preprocessed}/spicelib/devices -I${preprocessed}/xspice/icm/analog -D X_DISPLAY_MISSING -D CIDER -D SIMULATOR -D HAVE_DECL_BASENAME $SP_PREPROCESS_FLAG -c"
...
puts $O "#!/bin/tcsh"
puts $O "setenv PATH /home/ystatter/raspberrypi/tools/arm-bcm2708/arm-bcm2708-linux-gnueabi/arm-bcm2708-linux-gnueabi/bin/:/opt/centos/devtoolset-1.0/root/usr/bin/:\$PATH"
puts $O "/home/ystatter/raspberrypi/tools/arm-bcm2708/arm-bcm2708-linux-gnueabi/arm-bcm2708-linux-gnueabi/bin/g++ -L BerkeleyDB.6.0/lib/ -L /usr/bin/lib -lm -ltcl8.5  -ldl  -ldb-4.7  $object_files/*.o -o $target_name | & tee -a log"
close $O
