...
foreach topo_file [glob -nocomplain ~/Documents/*.stats.tcl] {
	...
	for {set i 0} {$i<$rez} {incr i} {
        ...
        ::SVG::svg width 1000 height 1100 {
            ::SVG::graph_hist stdev $stdev average $average x 100 y 100 width 900 height 900 data $hist_data connect all connect_pattern 1 connect_width 2 x_title "$name Ratio between Gamma and SPICE" y_title Count x_unit % y_unit {} title "Gamma vs SPICE $name error histogram for $topology_name topology"
        }
        ::SVG::svg width 1000 height 1100 {
