...
#    @ property:BW = [expr (1/(pow(10,[@ property:Adc]/20)-1))*[@ property:BW]]
    @ property:BW = [expr [@ property:BW]*0.24]
...
#    Info: Rand=$rand [expr 1.0/$BW_error] [eng $BW_error %]
    ...
    set entry {}
#    set O [open $regression_sample_file a]
    puts $O  [concat set sample($S) $iref $CMRR [@ property:CMRR] $PSRR [@ property:PSRR] $BW [@ property:BW] $spice_pm [expr 165-$gamma_pm] <br>]
     close $O
     incr S
