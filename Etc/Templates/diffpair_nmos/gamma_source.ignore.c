...
float *Plook_up_tables_pch_go_ss_LUT;
float *Plook_up_tables_pch_gb_ss_LUT;
float *Pp_1_gb;
float *Pp_1_gm;
float *Pp_1_go;
float *Pp_1_Ids;
...
float *Plook_up_tables_nch_go_ss_LUT;
float *Plook_up_tables_nch_gb_ss_LUT;
float *Pnin_1_gb;
float *Pnin_1_gm;
float *Pnin_1_go;
float *Pnin_1_Ids;
...
float look_up_tables_pch_go_ss_LUT;
float look_up_tables_pch_gb_ss_LUT;
float p_1_gb;
float p_1_gm;
float p_1_go;
float p_1_Ids;
...
float look_up_tables_nch_go_ss_LUT;
float look_up_tables_nch_gb_ss_LUT;
float nin_1_gb;
float nin_1_gm;
float nin_1_go;
float nin_1_Ids;
...
static int tcl_gamma_op_cmd(ClientData clientData,Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]) {
    ...
    for (op_it=0;(op_it<config_op_iterations)&&((leak>config_kcl_th)||(design_feedback>config_design_feedback_th));op_it++) {
        ...
        composite_gamma_gcc_interpolate_2p3(Plook_up_tables_pch_Ids_ss_LUT,Plook_up_tables_pch_gm_ss_LUT,Plook_up_tables_pch_go_ss_LUT,Plook_up_tables_pch_gb_ss_LUT,&(p_1_gb),&(p_1_gm),&(p_1_go),&(p_1_Ids),(outm_V)-(vdd_V),(outm_V)-(vdd_V),(vdd_V)-(vdd_V),size_Lp,size_Wp);
        if (p_1_Ids<0) p_1_Ids=0;
        if (p_1_Ids>1e-3) p_1_Ids=1e-3;
        p_1_Ids=-p_1_Ids;
        composite_gamma_gcc_interpolate_2p3(Plook_up_tables_pch_Ids_ss_LUT,Plook_up_tables_pch_gm_ss_LUT,Plook_up_tables_pch_go_ss_LUT,Plook_up_tables_pch_gb_ss_LUT,&(p_2_gb),&(p_2_gm),&(p_2_go),&(p_2_Ids),(outm_V)-(vdd_V),(outp_V)-(vdd_V),(vdd_V)-(vdd_V),size_Lp,size_Wp);
        if (p_2_Ids<0) p_2_Ids=0;
        if (p_2_Ids>1e-3) p_2_Ids=1e-3;
        p_2_Ids=-p_2_Ids;
        composite_gamma_gcc_interpolate_2p3(Plook_up_tables_nch_Ids_ss_LUT,Plook_up_tables_nch_gm_ss_LUT,Plook_up_tables_nch_go_ss_LUT,Plook_up_tables_nch_gb_ss_LUT,&(nin_1_gb),&(nin_1_gm),&(nin_1_go),&(nin_1_Ids),(inp_V)-(tail_V),(outm_V)-(tail_V),(CONST_0_V)-(tail_V),size_Ln,size_Wn);
        if (nin_1_Ids<0) nin_1_Ids=0;
        if (nin_1_Ids>1e-3) nin_1_Ids=1e-3;
        composite_gamma_gcc_interpolate_2p3(Plook_up_tables_nch_Ids_ss_LUT,Plook_up_tables_nch_gm_ss_LUT,Plook_up_tables_nch_go_ss_LUT,Plook_up_tables_nch_gb_ss_LUT,&(nin_2_gb),&(nin_2_gm),&(nin_2_go),&(nin_2_Ids),(inn_V)-(tail_V),(outp_V)-(tail_V),(CONST_0_V)-(tail_V),size_Ln,size_Wn);
        if (nin_2_Ids<0) nin_2_Ids=0;
        if (nin_2_Ids>1e-3) nin_2_Ids=1e-3;
        composite_gamma_gcc_interpolate_2p3(Plook_up_tables_nch_Ids_ss_LUT,Plook_up_tables_nch_gm_ss_LUT,Plook_up_tables_nch_go_ss_LUT,Plook_up_tables_nch_gb_ss_LUT,&(ntail_gb),&(ntail_gm),&(ntail_go),&(ntail_Ids),(vbias_V)-(CONST_0_V),(tail_V)-(CONST_0_V),(CONST_0_V)-(CONST_0_V),size_Ls,size_Ls*2*size_Wn/size_Ln);
        if (ntail_Ids<0) ntail_Ids=0;
        if (ntail_Ids>1e-3) ntail_Ids=1e-3;
        composite_gamma_gcc_interpolate_2p3(Plook_up_tables_nch_Ids_ss_LUT,Plook_up_tables_nch_gm_ss_LUT,Plook_up_tables_nch_go_ss_LUT,Plook_up_tables_nch_gb_ss_LUT,&(nref_gb),&(nref_gm),&(nref_go),&(nref_Ids),(vbias_V)-(CONST_0_V),(vbias_V)-(CONST_0_V),(CONST_0_V)-(CONST_0_V),size_Ls,size_Ls*2*size_Wn/size_Ln);
...
int Gamma_Init(Tcl_Interp *interp) {
    ...
    Plook_up_tables_pch_go_ss_LUT=(float *)get_LUT("look_up_tables:pch:go:ss");
    Plook_up_tables_pch_gb_ss_LUT=(float *)get_LUT("look_up_tables:pch:gb:ss");
    ...
    Plook_up_tables_nch_go_ss_LUT=(float *)get_LUT("look_up_tables:nch:go:ss");
    Plook_up_tables_nch_gb_ss_LUT=(float *)get_LUT("look_up_tables:nch:gb:ss");
