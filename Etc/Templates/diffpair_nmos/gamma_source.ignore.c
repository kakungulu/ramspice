...
static int tcl_gamma_op_cmd(ClientData clientData,Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]) {
    ...
    float current_transfer_p_1=Ted*((-(-(p_2_gm*((((nin_1_go+nin_1_gm)+nin_2_go)+nin_2_gm)+ntail_go)*(nref_go+nref_gm)-((-nin_2_go)-nin_2_gm)*(-nin_1_go)*(nref_go+nref_gm)))))/property_Adc;
    float current_transfer_p_2=Ted*((-(((p_1_go+p_1_gm)+nin_1_go)*((((nin_1_go+nin_1_gm)+nin_2_go)+nin_2_gm)+ntail_go)*(nref_go+nref_gm)+((-nin_1_go)-nin_1_gm)*(-(-nin_1_go)*(nref_go+nref_gm)))))/property_Adc;
    float current_transfer_nin_1=Ted*((-((((p_1_go+p_1_gm)+nin_1_go)*(-((-nin_2_go)-nin_2_gm)*(nref_go+nref_gm))-(p_2_gm*((((nin_1_go+nin_1_gm)+nin_2_go)+nin_2_gm)+ntail_go)*(nref_go+nref_gm)-((-nin_2_go)-nin_2_gm)*(-nin_1_go)*(nref_go+nref_gm)))+((-nin_1_go)-nin_1_gm)*p_2_gm*(nref_go+nref_gm))))/property_Adc;
    float current_transfer_nin_2=Ted*((-(((p_1_go+p_1_gm)+nin_1_go)*(((((nin_1_go+nin_1_gm)+nin_2_go)+nin_2_gm)+ntail_go)*(nref_go+nref_gm)-((-nin_2_go)-nin_2_gm)*(nref_go+nref_gm))+((-nin_1_go)-nin_1_gm)*(p_2_gm*(nref_go+nref_gm)-(-nin_1_go)*(nref_go+nref_gm)))))/property_Adc;
    float current_transfer_ntail=Ted*((-(((p_1_go+p_1_gm)+nin_1_go)*(-((-nin_2_go)-nin_2_gm)*(nref_go+nref_gm))+((-nin_1_go)-nin_1_gm)*p_2_gm*(nref_go+nref_gm))))/property_Adc;
    float current_transfer_nref=Ted*((-(((p_1_go+p_1_gm)+nin_1_go)*(-((-nin_2_go)-nin_2_gm)*(-ntail_gm))+((-nin_1_go)-nin_1_gm)*p_2_gm*(-ntail_gm))))/property_Adc;
...
int Gamma_Init(Tcl_Interp *interp) {
    ...
    c=create_context("ntail:cbd");
    Pntail_cbd=(float *)(&c->value.s);
    c=create_context("ntail:cbg");
    Pntail_cbg=(float *)(&c->value.s);
    c=create_context("ntail:cbs");
    ...
    c=create_context("nref:cbd");
    Pnref_cbd=(float *)(&c->value.s);
    c=create_context("nref:cbg");
    Pnref_cbg=(float *)(&c->value.s);
    c=create_context("nref:cbs");
    Pnref_cbs=(float *)(&c->value.s);
    c=create_context("nref:cbb");
