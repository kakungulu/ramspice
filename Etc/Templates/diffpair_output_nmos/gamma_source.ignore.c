...
static int tcl_gamma_op_cmd(ClientData clientData,Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]) {
    ...
    nin_1_cgs_out=0;
    // Miller Effect
    nin_1_cgs_out=nin_1_cgs*(1+(nin_1_go+nin_2_go+n_tail_go)/nin_1_gm);
    nin_1_cgs*=1+nin_1_gm/(nin_1_go+nin_2_go+n_tail_go);
    ...
    nin_2_cgs_out=0;
    // Miller Effect
    nin_2_cgs_out=nin_2_cgs*(1+(nin_1_go+nin_2_go+n_tail_go)/nin_2_gm);
    nin_2_cgs*=1+nin_2_gm/(nin_1_go+nin_2_go+n_tail_go);
    ...
    n_tail_cgs=0.66666*look_up_tables_nch_cox*size_Ls*size_Ls*2*size_Wn/size_Ln;
    if (!isfinite(n_tail_cgs))  {status_fail=7; return TCL_ERROR;}
    n_tail_cgs_out=0;
    n_tail_cgd=0.33333*look_up_tables_nch_cox*size_Ls*size_Ls*2*size_Wn/size_Ln;
    if (!isfinite(n_tail_cgd))  {status_fail=7; return TCL_ERROR;}
    n_tail_cgd_out=0;
    // Miller Effect
    n_tail_cgd_out=n_tail_cgd*(1+(nin_1_go+nin_2_go+n_tail_go)/n_tail_gm);
    n_tail_cgd*=1+n_tail_gm/(nin_1_go+nin_2_go+n_tail_go);
    n_ref_cgs=0.66666*look_up_tables_nch_cox*size_Ls*size_Ls*2*size_Wn/size_Ln;
    if (!isfinite(n_ref_cgs))  {status_fail=7; return TCL_ERROR;}
    n_ref_cgs_out=0;
    n_ref_cgd=0.33333*look_up_tables_nch_cox*size_Ls*size_Ls*2*size_Wn/size_Ln;
    ...
    n_out_cgs=0.66666*look_up_tables_nch_cox*size_Ls*size_Ls*size_Wn/size_Ln;
    if (!isfinite(n_out_cgs))  {status_fail=7; return TCL_ERROR;}
    n_out_cgs_out=0;
    n_out_cgd=0.33333*look_up_tables_nch_cox*size_Ls*size_Ls*size_Wn/size_Ln;
    if (!isfinite(n_out_cgd))  {status_fail=7; return TCL_ERROR;}
    n_out_cgd_out=0;
    // Miller Effect
    n_out_cgd_out=n_out_cgd*(1+(n_out_go+p_out_go)/n_out_gm);
    n_out_cgd*=1+n_out_gm/(n_out_go+p_out_go);
    ...
    p_out_cgd_out=0;
    // Miller Effect
    p_out_cgd_out=p_out_cgd*(1+(n_out_go+p_out_go)/p_out_gm);
    p_out_cgd*=1+p_out_gm/(n_out_go+p_out_go);
    s=-1;
    int BW_it;
    for (BW_it=0;BW_it<5;BW_it++)  s-=((-(((((((p_2_go+p_2_cgd_out*s)+nin_2_go)+nin_2_cgd_out*s)+p_out_cgs*s)+p_out_cgd*s)*(((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))-p_2_gm*((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))-((-nin_2_go)-nin_2_gm)*(-((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s))))))/((-((((((p_2_cgd_out+nin_2_cgd_out)+p_out_cgs)+p_out_cgd)*(((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))+(((((p_2_go+p_2_cgd_out*s)+nin_2_go)+nin_2_cgd_out*s)+p_out_cgs*s)+p_out_cgd*s)*(((((((p_1_cgs+p_2_cgs)+p_2_cgd)+nin_1_cgd_out)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(n_out_cgd_out+p_out_cgd_out))*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*((nin_1_cgs_out+nin_2_cgs_out)+n_tail_cgd_out))*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))+((-nin_1_go)-nin_1_gm)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd)))))-p_2_gm*((-nin_1_go)-nin_1_gm)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))))-((-nin_2_go)-nin_2_gm)*(-((((p_1_cgs+p_2_cgs)+p_2_cgd)+nin_1_cgd_out)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s))+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))))))));
    property_BW_s=(-((((((p_2_cgd_out+nin_2_cgd_out)+p_out_cgs)+p_out_cgd)*(((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))+(((((p_2_go+p_2_cgd_out*s)+nin_2_go)+nin_2_cgd_out*s)+p_out_cgs*s)+p_out_cgd*s)*(((((((p_1_cgs+p_2_cgs)+p_2_cgd)+nin_1_cgd_out)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(n_out_cgd_out+p_out_cgd_out))*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*((nin_1_cgs_out+nin_2_cgs_out)+n_tail_cgd_out))*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))+((-nin_1_go)-nin_1_gm)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd)))))-p_2_gm*((-nin_1_go)-nin_1_gm)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))))-((-nin_2_go)-nin_2_gm)*(-((((p_1_cgs+p_2_cgs)+p_2_cgd)+nin_1_cgd_out)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s))+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd)))))));
    p1=-s;
    property_BW=fabs(p1/(2*3.141592656));
    if (!isfinite(property_BW))  {status_fail=8; return TCL_ERROR;}
    s-=1e3;
    for (BW_it=0;BW_it<20;BW_it++)  s-=(((-(((((((p_2_go+p_2_cgd_out*s)+nin_2_go)+nin_2_cgd_out*s)+p_out_cgs*s)+p_out_cgd*s)*(((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))-p_2_gm*((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))-((-nin_2_go)-nin_2_gm)*(-((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s))))))*(s+p1-5e2))/(((-((((((p_2_cgd_out+nin_2_cgd_out)+p_out_cgs)+p_out_cgd)*(((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))+(((((p_2_go+p_2_cgd_out*s)+nin_2_go)+nin_2_cgd_out*s)+p_out_cgs*s)+p_out_cgd*s)*(((((((p_1_cgs+p_2_cgs)+p_2_cgd)+nin_1_cgd_out)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(n_out_cgd_out+p_out_cgd_out))*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*((nin_1_cgs_out+nin_2_cgs_out)+n_tail_cgd_out))*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))+((-nin_1_go)-nin_1_gm)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd)))))-p_2_gm*((-nin_1_go)-nin_1_gm)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))))-((-nin_2_go)-nin_2_gm)*(-((((p_1_cgs+p_2_cgs)+p_2_cgd)+nin_1_cgd_out)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s))+((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(-((n_out_cgd_out+p_out_cgd_out)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((n_tail_cgs+n_tail_cgd)+n_ref_cgs)+n_out_cgs)+n_out_cgd))))))))*(s+p1-5e2)-((-(((((((p_2_go+p_2_cgd_out*s)+nin_2_go)+nin_2_cgd_out*s)+p_out_cgs*s)+p_out_cgd*s)*(((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(((((((nin_1_go+nin_1_gm)+nin_1_cgs_out*s)+nin_2_go)+nin_2_gm)+nin_2_cgs_out*s)+n_tail_go)+n_tail_cgd_out*s)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)+((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_1_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))-p_2_gm*((-nin_1_go)-nin_1_gm)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))-((-nin_2_go)-nin_2_gm)*(-((((((p_1_go+p_1_gm)+p_1_cgs*s)+p_2_cgs*s)+p_2_cgd*s)+nin_1_go)+nin_1_cgd_out*s)*(-(((n_out_go+n_out_cgd_out*s)+p_out_go)+p_out_cgd_out*s)*(-nin_2_go)*((((((n_tail_cgs*s+n_tail_cgd*s)+n_ref_go)+n_ref_gm)+n_ref_cgs*s)+n_out_cgs*s)+n_out_cgd*s)))))));
    p2=-s;
    if (!isfinite(p1)) {
    ...
    p_1_Nf=20*p_1_Nf_unit*p_1_go*p_1_go/(size_Wp*size_Lp);
    ...
    p_2_Nf=20*p_2_Nf_unit*p_2_go*p_2_go/(size_Wp*size_Lp);
    ...
    nin_1_Nf=20*nin_1_Nf_unit*nin_1_go*nin_1_go/(size_Wn*size_Ln);
    ...
    nin_2_Nf=20*nin_2_Nf_unit*nin_2_go*nin_2_go/(size_Wn*size_Ln);
    ...
    n_tail_Nf=20*n_tail_Nf_unit*n_tail_go*n_tail_go/(size_Ls*2*size_Wn/size_Ln*size_Ls);
    ...
    n_ref_Nf=20*n_ref_Nf_unit*n_ref_go*n_ref_go/(size_Ls*2*size_Wn/size_Ln*size_Ls);
    ...
    n_out_Nf=20*n_out_Nf_unit*n_out_go*n_out_go/(size_Ls*size_Wn/size_Ln*size_Ls);
    ...
    p_out_Nf=20*p_out_Nf_unit*p_out_go*p_out_go/(size_Wo*size_Lo);
