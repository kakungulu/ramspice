...
static int tcl_gamma_op_cmd(ClientData clientData,Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]) {
    ...
    //AC output: (-(((-Gds_in_mid)*(n_ref_gm+n_ref_cdg*s)*(-param_in)-(Gds_in_mid+n_ref_cgg*s)*((-(size_iref-n_ref_Ideq))+(n_ref_cds*s+n_ref_cdb*s)*(-param_vdd)))-(n_ref_cgs*s+n_ref_cgb*s)*(-(n_ref_gm+n_ref_cdg*s)*(-param_vdd))))/(-((-(Gds_in_mid+n_ref_cgg*s)*(-(n_ref_go+n_ref_cdd*s)))+n_ref_cgd*s*(-(n_ref_gm+n_ref_cdg*s))))
    //AC gain: (-(-Gds_in_mid)*(n_ref_gm+n_ref_cdg*s))/(-((-(Gds_in_mid+n_ref_cgg*s)*(-(n_ref_go+n_ref_cdd*s)))+n_ref_cgd*s*(-(n_ref_gm+n_ref_cdg*s))))
    ...
    for (BW_it=0;BW_it<5;BW_it++)  s-=((-((-(Gds_in_mid+n_ref_cgg*s)*(-(n_ref_go+n_ref_cdd*s)))+n_ref_cgd*s*(-(n_ref_gm+n_ref_cdg*s)))))/((-((-(n_ref_cgg*(-(n_ref_go+n_ref_cdd*s))+(Gds_in_mid+n_ref_cgg*s)*(-n_ref_cdd)))+(n_ref_cgd*(-(n_ref_gm+n_ref_cdg*s))+n_ref_cgd*s*(-n_ref_cdg)))));
    property_BW_s=(-((-(n_ref_cgg*(-(n_ref_go+n_ref_cdd*s))+(Gds_in_mid+n_ref_cgg*s)*(-n_ref_cdd)))+(n_ref_cgd*(-(n_ref_gm+n_ref_cdg*s))+n_ref_cgd*s*(-n_ref_cdg))));
    p1=-s;
    if (!isfinite(property_BW))  {status_fail=8; return TCL_ERROR;}
    s-=1e3;
    for (BW_it=0;BW_it<20;BW_it++)  s-=(((-((-(Gds_in_mid+n_ref_cgg*s)*(-(n_ref_go+n_ref_cdd*s)))+n_ref_cgd*s*(-(n_ref_gm+n_ref_cdg*s)))))*(s+p1-5e2))/(((-((-(n_ref_cgg*(-(n_ref_go+n_ref_cdd*s))+(Gds_in_mid+n_ref_cgg*s)*(-n_ref_cdd)))+(n_ref_cgd*(-(n_ref_gm+n_ref_cdg*s))+n_ref_cgd*s*(-n_ref_cdg)))))*(s+p1-5e2)-((-((-(Gds_in_mid+n_ref_cgg*s)*(-(n_ref_go+n_ref_cdd*s)))+n_ref_cgd*s*(-(n_ref_gm+n_ref_cdg*s))))));
    p2=-s;
    if (!isfinite(p1)) {
    ...
    property_Nt=(current_transfer_n_ref*current_transfer_n_ref*n_ref_Nt)/property_Adc;
    property_Nf=(current_transfer_n_ref*current_transfer_n_ref*n_ref_Nf)/property_Adc;
    property_fc=property_Nf/property_Nt;
    property_TotalNoise=(log(2*property_BW)*property_Nf+2*property_BW*property_Nt);
    property_Area=1e12*(size_W*size_L);
