...
#line 1 "./digital/d_dff/cfunc.mod"
#include "ngspice/cm.h"
extern void cm_d_dff(Mif_Private_t *);
#line 1 "./digital/d_dff/cfunc.mod"
/*.......1.........2.........3.........4.........5.........6.........7.........8
================================================================================
...
void cm_d_dff(Mif_Private_t *mif_private) 

{
    ...
    *clk = ((Digital_t*)(mif_private->conn[1]->port[0]->input.pvalue))->state;
    ...
    if (0.0 == mif_private->circuit.time) {   /****** Initial conditions...output w/o delays ******/
        ...
        *out = *out_old = temp;
            ...
            if ( *reset != *reset_old ) { /* either reset or reset release */
                ...
                if ( (*clk != *clk_old) && (*reset != ONE) &&
                    ...
                    case ONE:
                        ...
                        temp = ((Digital_t*)(mif_private->conn[0]->port[0]->input.pvalue))->state;
        ...
        if ( *out != *out_old ) { /*** output value is changing ***/
            ...
            case 1: 
                    if ( !mif_private->conn[4]->is_null ) {
                        mif_private->conn[4]->port[0]->delay += mif_private->param[4]->element[0].rvalue;
                    }
                    if ( !mif_private->conn[5]->is_null ) {
