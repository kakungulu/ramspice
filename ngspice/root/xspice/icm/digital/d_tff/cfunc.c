...
#line 1 "./digital/d_tff/cfunc.mod"
#include "ngspice/cm.h"
extern void cm_d_tff(Mif_Private_t *);
#line 1 "./digital/d_tff/cfunc.mod"
/*.......1.........2.........3.........4.........5.........6.........7.........8
================================================================================
...
void cm_d_tff(Mif_Private_t *mif_private) 
            ...
            if ( *reset != *reset_old ) { /* either reset or reset release */
                ...
                if ( (*clk != *clk_old) && (*reset != ONE) &&
                    ...
                    case ONE:
                        ...
                        toggle_input = ((Digital_t*)(mif_private->conn[0]->port[0]->input.pvalue))->state;
