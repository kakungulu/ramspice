...
typedef struct BSIM3v32InnerCalc BSIM3v32InnerCalc;
typedef struct BSIM3v32InnerCalc {
    BSIM3v32instance *inst;
    BSIM3v32InnerCalc *next;
    #Foreach: var $::bsim3v32_internal_calculation_vars {
        double $var;
    }
};
BSIM3v32InnerCalc *BSIM3v32InnerCalcList;
