...
//    #Info: "BSIM4v5temp %x %x" inModel ckt
    ...
    {    Temp = ckt->CKTtemp;
        ...
        * exp(21.5565981 - Eg0 / (2.0 * Vtm0));
		...
		//if (pParam->BSIM4v5eta0<0.0) pParam->BSIM4v5eta0 = model->BSIM4v5eta0;
		...
		//Info: "Pclm=%g+%g*%g+%g*%g+%g*%g=%g" model->BSIM4v5pclm model->BSIM4v5lpclm Inv_L model->BSIM4v5wpclm Inv_W model->BSIM4v5ppclm Inv_LW pParam->BSIM4v5pclm
		//if (pParam->BSIM4v5pclm<0.0) pParam->BSIM4v5pclm=model->BSIM4v5pclm;
