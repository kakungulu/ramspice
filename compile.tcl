...
foreach target [list regular silent debug] target_flag {TCL_MSG_REG TCL_MSG_SILENT TCL_MSG_DEBUG} {
    ...
    set preprocessed /tmp/ramspice_build/preprocessed-$target
    set object_files /tmp/ramspice_build/object_files-$target
    set target_name $::env(RAMSPICE)/bin/ramspice-$target
    ###############
    ...
    set pre_c "/usr/bin/gcc -I${preprocessed} -I. -lm -ltcl8.5  -g -O5 -Wall -Wextra -Wmissing-prototypes -Wstrict-prototypes -Wnested-externs -Wold-style-definition -Wredundant-decls -Wconversion -I/usr/include/c++/4.4.4/x86_64-redhat-linux -ldb-6.0  -I${preprocessed}/maths/poly -Imaths/poly -I${preprocessed}/frontend -Ifrontend -I${preprocessed}/spicelib/devices -Ispicelib/devices -I${preprocessed}/xspice/icm/analog -Ixspice/icm/analog -D SENSDEBUG -D X_DISPLAY_MISSING -D CIDER -D SIMULATOR -c"
    set pre_cpp "/usr/bin/g++  -I${preprocessed} -lm -ltcl8.5  -g -O5 -Wall -Wextra -fpermissive -Wredundant-decls -Wconversion -I${preprocessed}/maths/poly -I${preprocessed}/frontend -I${preprocessed}/spicelib/devices -I${preprocessed}/xspice/icm/analog -D X_DISPLAY_MISSING -D CIDER -D SIMULATOR -D HAVE_DECL_BASENAME -c"
...
if {![file exists $::env(RAMSPICE)/ramspice]} {
    file link -s ramspice bin/ramspice-regular
}
