...
extern float Captured_Ssi;
extern float Captured_EffFreq;
extern float Captured_Thermal_Noise;
...
NOISEan (CKTcircuit *ckt, int restart)
{
    ...
    if (Captured_Quick_Noise>0.0) {
    CKTop(ckt, (ckt->CKTmode & MODEUIC) | MODEDCOP | MODEINITJCT,
    ...
    CKTnoise(ckt,N_DENS,N_OPEN,data);		 
    CKTnoise(ckt,N_DENS,N_CALC,data);		 
    FREE(data);
    return(OK);
    }
    ///////////// End Testing quick analysis			 
	...
	switch (job->NstpType) {
        ...
        default:
	    #Error: "Bad Param1: %d" job->NstpType
            return(E_BADPARM);
        }
	...
	case DECADE:
        ...
        default:
	    #Info: "Bad Param2: %d" job->NstpType
            return(E_BADPARM);
    ...
    case LINEAR:
        ...
        break;
    default:
	#Error: "Bad Param3: %d" job->NstpType
        return(E_BADPARM);
    }
