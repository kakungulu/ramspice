              ...
              long int continuemode, int iterlim)
{
    ...
    ckt->CKTmode = firstmode;
    #Info: "Starting dynamic gmin stepping"
    ...
    while ((!success) && (!failed)) {
        #Info: "Trying gmin = %12.4E " ckt->CKTdiagGmin
        ckt->CKTnoncon = 1;
    ...
    if (converged != 0) {
        ...
        #Info: "Dynamic gmin stepping completed"
#ifdef XSPICE
        /* gtri - begin - wbk - add convergence problem reporting flags */
        ckt->enh->conv_debug.last_NIiter_call = MIF_FALSE;
        /* gtri - end - wbk - add convergence problem reporting flags */
               ...
               long int continuemode, int iterlim)
{
    ...
    #Info: "Supplies reduced to %8.4f%% " ckt->CKTsrcFact*100
    converged = NIiter (ckt, ckt->CKTdcTrcvMaxIter);
    ...
    if (converged == 0) {
        ...
        #Info: "One successful source step"
    ...
    if (ConvFact != 1) {
        ...
        #Info: "Source stepping completed"
        return (0);
    }
}
