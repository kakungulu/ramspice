...
#line 1 "./digital/d_state/cfunc.mod"
...
FILE *fopen_with_path_cfunc1(const char *path, const char *mode)
{
...
/*    char buf[100];*/
    ...
    if(mif_private->circuit.init) {  /* initial pass */ 
        ...
        state_file = fopen_with_path_cfunc1( mif_private->param[2]->element[0].svalue, "r");
