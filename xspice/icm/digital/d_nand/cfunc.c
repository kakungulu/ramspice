...
#line 1 "./digital/d_nand/cfunc.mod"
#include "ngspice/cm.h"
extern void cm_d_nand(Mif_Private_t *);
#line 1 "./digital/d_nand/cfunc.mod"
/*.......1.........2.........3.........4.........5.........6.........7.........8
================================================================================
...
void cm_d_nand(Mif_Private_t *mif_private) 
    ...
    *out = ZERO;
    for (i=0; i<size; i++) {
        ...
        if ( FALSE == mif_private->conn[0]->is_null ) {
            ...
            /* if a 0, set *out high */
            if ( ZERO == (input = ((Digital_t*)(mif_private->conn[0]->port[i]->input.pvalue))->state) ) {
                *out = ONE;
                break;
            }
            else {                    
