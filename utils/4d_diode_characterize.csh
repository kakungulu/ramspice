...
###             utils/4d_diode_characterize.tcl -vgs_rez $vgs -vbs_rez $vbs -l_rez $l -tech $tech -topv $topv -device nch 
###             utils/4d_diode_characterize.tcl -vgs_rez $vgs -vbs_rez $vbs -l_rez $l -tech $tech -topv $topv -device pch 
### 	    foreach dev (nch pch)
...
###                      # utils/4d_diode_analyze_stats.tcl -topv $topv -tech $tech -device $dev -process $corner -size 500 -source $RAMSPICE/Tech_DB/$tech/4d_diode/$rez -interpolation $interpolation > $RAMSPICE/Tech_DB/$tech/4d_diode/$rez/$dev.$corner.$interpolation.stats
### 		  end
### 	       end	
### 	    end	
###         end
