...
if {![file exists $::env(RAMSPICE)/Tech_DB/${tech}/reduced]} {
    file mkdir $::env(RAMSPICE)/Tech_DB/${tech}/reduced
}
if {![file exists $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}]} {
    file mkdir $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}
}
...
foreach type [split $device :] {
    ...
    set vt_db_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_vt.db
    set va_db_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_va.db
    set min_vt_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_min_vt.tcl
    set ids_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_ids.db
    set gm_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_gm.db
    set ro_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_ro.db
    set vth_mis_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_vth_mis.db
    set ids_mis_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_ids_mis.db
    ...
    foreach ::corner $::corner_list {
        set thermal_noise_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_${::corner}_thermal_noise.db
        set flicker_noise_file $::env(RAMSPICE)/Tech_DB/${tech}/reduced/${::rez}/${tech}_${type}_${::corner}_flicker_noise.db
